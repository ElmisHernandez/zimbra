...
```
sudo -u zimbra -- zmprov mcf zimbraHttpThrottleSafeIPs 10.1.2.3/32 zimbraHttpThrottleSafeIPs 192.188.4.0/24
```
...
sudo -u zimbra -- zmprov mcf +zimbraHttpThrottleSafeIPs 192.188.4.0/24
```
